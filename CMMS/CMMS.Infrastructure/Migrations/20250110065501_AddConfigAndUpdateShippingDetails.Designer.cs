...
namespace CMMS.Infrastructure.Migrations
{
    ...
    [Migration("20250110065501_AddConfigAndUpdateShippingDetails")]
    partial class AddConfigAndUpdateShippingDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMMS.Core.Entities.Configurations.ConfigCustomerDiscount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<decimal>("Agency")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("ConfigCustomerDiscounts");
                });

            modelBuilder.Entity("CMMS.Core.Entities.Configurations.ConfigShipping", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<decimal>("AdditionalKgFee")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AdditionalKmFee")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("First10KgFee")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("First5KmFree")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("ConfigShippings");
                });

            modelBuilder.Entity("CMMS.Core.Entities.ConversionUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.GoodsNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.GoodsNoteDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("GoodsNoteId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("GoodsNoteId");

                    b.HasIndex("MaterialId");

                    b.HasIndex("VariantId");

                    b.ToTable("GoodsNoteDetails");
                });
            ...
            modelBuilder.Entity("CMMS.Core.Entities.ImportDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.ShippingDetail", b =>
                {
                    ...
                    b.Property<int?>("ShippingDetailStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.StoreMaterialImportRequest", b =>
                {
                    ...
                    b.ToTable("StoreMaterialImportRequests");
                });
            ...
            modelBuilder.Entity("CMMS.Core.Entities.Variant", b =>
                {
                    ...
                    b.Property<Guid?>("AttributeVariantId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ConversionUnitId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.Warehouse", b =>
                {
                    ...
                    b.Property<decimal?>("InRequestQuantity")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.GoodsNoteDetail", b =>
                {
                    b.HasOne("CMMS.Core.Entities.GoodsNote", "GoodsNote")
                        .WithMany("GoodsNoteDetails")
                        .HasForeignKey("GoodsNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CMMS.Core.Entities.Import", b =>
                {
                    b.HasOne("CMMS.Core.Entities.Material", null)
                        .WithMany("Imports")
                        .HasForeignKey("MaterialId");
                    ...
                    b.HasOne("CMMS.Core.Entities.Variant", null)
                        .WithMany("Imports")
                        .HasForeignKey("VariantId");
            ...
            modelBuilder.Entity("CMMS.Core.Entities.ImportDetail", b =>
                {
                    b.HasOne("CMMS.Core.Entities.Import", "Import")
            ...
            modelBuilder.Entity("CMMS.Core.Entities.Variant", b =>
                {
                    b.HasOne("CMMS.Core.Entities.Variant", "AttributeVariant")
                        .WithMany()
                        .HasForeignKey("AttributeVariantId");
