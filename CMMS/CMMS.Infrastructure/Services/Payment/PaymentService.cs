...
namespace CMMS.Infrastructure.Services.Payment
{
	public interface IPaymentService
	{
		...
		VnpayResponseData VnpayReturnUrl(VnpayPayResponse vnpayPayResponse, string customerId);
	}
	public class PaymentService : IPaymentService
	{
		...
		public VnpayResponseData VnpayReturnUrl(VnpayPayResponse vnpayPayResponse, string customerId)
		{
			try
			{
				...
				using (var scope = _serviceScopeFactory.CreateScope())
				{
					...
					if (payment != null)
					{
						...
						var invoice = new Invoice
						{
							CustomerId = customerId,
							InvoiceDate = DateTime.Now,
							InvoiceStatus = (int)InvoiceStatus.PaymentSucces,
							TotalAmount = (decimal)vnpayPayResponse.vnp_Amount,
						};
