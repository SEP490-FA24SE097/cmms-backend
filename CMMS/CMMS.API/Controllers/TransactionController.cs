    ...
    public class TransactionController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTransactionAsync([FromQuery] TransactionFilterModel filterModel)
        {
            if (filterModel.CustomerId != null)
            {
                ...
                var filterCustomerListPaged = customerTransactionResult.OrderBy(_ => _.TransactionDate).ToPageList(filterModel.defaultSearch.currentPage, filterModel.defaultSearch.perPage);
                return Ok(new
                {
